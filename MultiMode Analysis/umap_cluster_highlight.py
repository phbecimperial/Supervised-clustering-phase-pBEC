...
if __name__ == "__main__":
    ...
    with open('Apr_2001_features.pkl', 'rb') as f:
    ...
    membership_mat = Meta_classifier.quick_fcmeans(cnn_embed, num_clusters = num_clusters, m = 2, return_matrix= True)
    ...
    for i, col in enumerate(membership_mat):
        ...
        # axes[i].scatter(cnn_embed[:,0], cnn_embed[:,1], c = col, cmap = 'Spectral_r',s = 0.8 )
